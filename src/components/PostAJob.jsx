    ...
    <div className="bg-gray-400 items-center justify-center flex flex-col h-screen w-screen p-4">
      <form onSubmit={handleSubmite} className="flex flex-col space-x-5 gap-10">
        ...
        <input
          ...
          className="bg-white rounded-2xl border-gray-300 w-70 outline-none flex p-1 px-3 border-2 focus:ring-2 focus:ring-slate-500"
          type="text"
        ...
        <input
          ...
          className="bg-white border-gray-300 rounded-2xl w-70 outline-none flex p-1 px-3 border-2 focus:ring-2 focus:ring-slate-500 "
          type="text"
        ...
        <button
          className="bg-slate-600 text-white w-70 font-semibold py-2 rounded-3xl hover:bg-slate-700 active:scale-95 transition"
          type="submit "
        >
          {" "}
          Post
